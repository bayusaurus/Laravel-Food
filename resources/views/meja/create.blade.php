        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    ...
                    <form class="user py-3 col-md-8 col-sm-8" method="post" action="{{ route('meja.create') }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Create New Meja</h1>
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="input-group @error('kapasitas') is-invalid @enderror">
                                ...
                                <input type="number" name="kapasitas" value="{{ old('harga') }}" id="kapasitas"
                        ...
                        <div class="col-md-4"><button type="submit" class="btn btn-primary form-control">Tambah</button>
                        </div>
