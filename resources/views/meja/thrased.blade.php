...
@section('scripts')
    ...
    <script>
        ...
        $('.restoreMeja').on('click', function(e) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-success btn-sm btn-circle showMeja"
                                                    link="{{ route('meja.thrased.show', $meja->id) }}">
                                                    <i class="fas fa-info-circle"></i>
                                                </button>
                                                <button type="button" class="btn btn-primary btn-sm btn-circle restoreMeja"
                                                    link="{{ route('meja.restore', $meja->id) }}" nama="{{ $meja->nama }}">
